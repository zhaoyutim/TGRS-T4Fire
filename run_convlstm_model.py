...
if __name__=='__main__':
    ...
    if load_weights== 'yes':
        model.load_weights('/geoinfo_vol1/zhao2/proj3_'+model_name+'_pretrained_'+backbone+'run'+str(run))
    else:
        ...
        model.save('/geoinfo_vol1/zhao2/proj3_'+model_name+'_pretrained_'+backbone+'run'+str(run))
