...
def get_convlstm_unet(input_shape):
    ...
    conv1 = TimeDistributed(Conv2D(64, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal'), input_shape=(None,10,224,224,5))(inputs)
    conv1 = TimeDistributed(Conv2D(1, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal'), input_shape=(None,10,224,224,64))(conv1)
    ...
    # merge6 = tf.concat([convlstm4,up6], axis = 4)
